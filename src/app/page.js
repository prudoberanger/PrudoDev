    ...
    <>
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              {/* Subtitle */}
              <p className="text-gray-400 font-medium tracking-widest text-xs uppercase mb-3">
        ...
        <ScrollAnimator>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-black">
              Des Solutions Digitales<br />Complètes
            </h2>
          </div>
        </ScrollAnimator>
          ...
          <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
            ...
            <div className="service-card bg-white rounded-3xl p-6 min-w-[300px] snap-start flex-shrink-0">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-5">
                Des sites entièrement personnalisés et responsive, conçus pour refléter votre marque et atteindre vos objectifs en ligne.
              </p>
            ...
            <div className="service-card bg-white rounded-3xl p-6 min-w-[300px] snap-start flex-shrink-0">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-5">
                Des campagnes publicitaires ciblées sur Google pour attirer des clients qualifiés et maximiser votre retour sur investissement.
              </p>
            ...
            <div className="service-card bg-white rounded-3xl p-6 min-w-[300px] snap-start flex-shrink-0">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-5">
                Optimisation de votre site pour apparaître en première page Google et attirer un trafic organique qualifié durablement.
              </p>
        ...
        <div className="mt-16 overflow-hidden">
          <div className="tags-track">
            {tags.map((tag, i) => (
              <span
                key={i}
                className="inline-flex items-center bg-white/20 text-black font-semibold text-sm px-5 py-2.5 rounded-full mx-2 whitespace-nowrap"
              >
                {tag}
              </span>
            ))}
      ...
      <section className="bg-white py-20 px-5">
        <div className="max-w-4xl mx-auto">
          <ScrollAnimator className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-black">
              Pourquoi choisir{' '}
              <span className="gold-underline text-black">PrudoDev ?</span>
            </h2>
          </ScrollAnimator>
          ...
          <ScrollAnimator className="flex justify-center mb-12">
            <div className="relative">
              <div className="w-52 h-52 rounded-full overflow-hidden border-4 border-[#F0B429] shadow-xl">
                <Image
                  src="https://res.cloudinary.com/dvwctezb3/image/upload/v1776634274/20260419_221914_uvi7xr.png"
                  alt="Prudencio — PrudoDev"
                  width={208}
                  height={208}
                  className="w-full h-full object-cover"
                />
          ...
          <ScrollAnimator>
            <div className="bg-white rounded-3xl p-8 md:p-10">
              <h2 className="text-2xl md:text-3xl font-black text-black mb-4">
                Et si on discutait de votre <span className="text-[#F0B429]">projet</span> ?
              </h2>
              <p className="text-gray-500 text-sm md:text-base leading-relaxed mb-8">
                Votre entreprise mérite une stratégie digitale puissante. Je vous aide à structurer votre vision, identifier vos opportunités et implémenter des solutions efficaces.
              </p>
              <a
                href="https://wa.me/+22965359515"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-black text-white font-semibold px-7 py-4 rounded-full hover:bg-gray-900 transition-colors text-sm"
              >
      ...
      <section className="bg-white py-20 px-5" id="portfolio">
        <div className="max-w-4xl mx-auto">
          <ScrollAnimator className="flex items-center justify-between mb-8">
            ...
            <a href="https://wa.me/+22965359515" target="_blank" rel="noopener noreferrer" className="text-black font-semibold text-sm flex items-center gap-1 hover:text-[#F0B429] transition-colors">
              Voir plus →
            </a>
          </ScrollAnimator>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <ScrollAnimator className="bg-gray-50 rounded-3xl overflow-hidden">
              <div className="h-52 overflow-hidden">
                <Image
                  src="https://res.cloudinary.com/dvwctezb3/image/upload/v1776622937/Screenshot_20260417-190519_1_tmy04i.jpg"
      ...
      <section className="bg-[#F0B429] py-20 px-5">
        <div className="max-w-4xl mx-auto">
          <ScrollAnimator className="text-center mb-12">
            <span className="section-badge mb-4 block w-fit mx-auto">EXPERTISE</span>
            <h2 className="text-3xl md:text-4xl font-black text-black gold-underline inline-block">
              Retours d&apos;expérience<br />de nos clients
            </h2>
          </ScrollAnimator>
